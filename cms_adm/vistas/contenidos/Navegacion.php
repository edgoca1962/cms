   <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
         ...
         <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="vistas/img/usuarios/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
               </div>
               <div class="info">
               ...
               <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column nav-compact" data-widget="treeview" role="menu" data-accordion="false" id="menu">
                  ...
                  <li class="nav-item has-treeview">
                     ...
                     <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                           <a href="Panel_b" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Segundo Panel</p>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a href="Panel_c" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Tercer Panel</p>
                           </a>
                        </li>
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="Ingreso">Salir</a></li>
                     </ol>
                  </div><!-- /.col -->
               </div><!-- /.row -->
            </div><!-- /.container-fluid -->
      ...
      <footer class="main-footer">
         ...
         <!-- Default to the left -->
         <strong>Copyright &copy; 2020-2021 <a href="#">CMS | Administración</a>.</strong> Versión gratuita.
      </footer>
   </div>
   <!-- ./wrapper -->